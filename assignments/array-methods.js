...
runners.forEach(function(currentRunner){
  ...
  fullNames.push(currentRunner.last_name);
});
...
runners.forEach(function(runnerName){
  firstNamesAllCaps.push(runnerName.first_name.toUpperCase())
});
...
// DIDN'T USE EMPTY ARRAY
// let runnersLargeSizeShirt = [];
const shirtSizeLarge = runners.filter(function(shirt){
  return shirt.shirt_size === 'L';
});
console.log(shirtSizeLarge);
